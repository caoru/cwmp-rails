...
(function() {
  App.parameters = App.cable.subscriptions.create("ParametersChannel", {
    ...
    received: function(data) {
      var text;
      if (data.id !== gRequestId.toString()) {
        return;
      }
      ...
      return $('#api_response_text').val(text + data.data + "\n");
    }
  });
...
(function() {
  App.tr_logs = App.cable.subscriptions.create("TrLogsChannel", {
    ...
    received: function(data) {
      ...
      return $(document).on('turbolinks:load', static_pages_ready);
    }
  });
...
//$(document).ready(function() {
  ...
  $('#instanceManagement .addRequest').click(function() {
    index = $('#instanceManagement input[name=index]').val();
    nodeId = $('#instanceManagement input[name=nodeId]').val();
    node = $('#tree').treeview('getNode', nodeId);
  ...
  function addRequestParameter(data) {
    ...
    if ($('#tree').hasClass("get")) {
      ...
      $.get("/values/form_set", { "name" : name, "type" : data.type, "enums" : data.enums },  function( data ) {
        $('#parameters').append(data.html);
  ...
  $.get("/api/model", { "tr" : $('input[type=radio][name=tr_select]').val() },  function( data ) {
    $('#tree').treeview({
      data: data,
  ...
  $('input[name="commit"].api_values').click(function() {
    ...
    var validate = true;
    var method = "GET";
    var message = "Processing Get Parameter Values...";

    if ($(this).hasClass("set")) {
      method = "POST";
    var message = "Processing Set Parameter Values...";
    }
